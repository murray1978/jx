...
public final class BinaryCodeDynamicIA32 {
    ...
    */ 
	...
	Enumeration jxEnum = symbolTable.elements(); 
	Vector unresolvedEntries = new Vector(); 
	while(jxEnum.hasMoreElements()) {
	    SymbolTableEntryBase entry = (SymbolTableEntryBase)jxEnum.nextElement();
  ...
  public void spin_unlock(Ref lock) {
    ...
    */ 
	...
	for(int i=0;i<exceptionHandlers.size();i++) {
	    ...
	    Debug.jxAssert(handlerArray[i].isFinished()); 
	}
	return handlerArray; 
    }
