...
public abstract class SymbolTableEntryBase {
    ...
    */ 
	...
	Debug.jxAssert(nr!=0,"Symbol not registered in SymbolTableEntryBase: "+this.getClass().getName());
    ...
    */ 
	...
	Debug.jxAssert(isImmediateRelative); 
    ...
    */ 
	...
	// Debug.jxAssert(numBytes==4 || (value < 128 && value >= -128)); 
