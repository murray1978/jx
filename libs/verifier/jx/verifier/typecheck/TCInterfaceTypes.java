...
public class TCInterfaceTypes extends TCTypes {
	...
	for (Enumeration jxEnum = target.elements(); jxEnum.hasMoreElements(); ) {
	    if (((String)jxEnum.nextElement()).equals(element))
	...
	for (Enumeration jxEnum = source.elements(); jxEnum.hasMoreElements(); )
	    addUnique(target, (String)jxEnum.nextElement());
    }
